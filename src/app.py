...
activities = {
    ...
    # Sports
    "Basketball": {
        "description": "Team sport focused on skill, teamwork, and fitness",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": []
    },
    "Swimming": {
        "description": "Swimming lessons and competitions for all levels",
    ...
    # Artistic
    "Sculpture Workshop": {
        "description": "Explore 3D art using clay, wood, and other materials",
